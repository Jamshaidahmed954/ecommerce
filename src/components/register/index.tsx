...
import {
  ...
  signInWithMicrosoft,
  signUpWithEmail,
} from "@/firebaseAuthenication/auth";
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center items-center p-2">
        ...
        <div className="w-full sm:max-w-sm sm:px-12 block md:hidden mb-4">
          ...
          <div className="text-center">
            <img
              src="/Layer_1.png"
              alt="Logo"
              className="mx-auto w-32 sm:w-36 mb-6"
            />
            <h2 className="text-2xl font-semibold text-[#00144F] mb-2">
              the Lost Library of Alexandria
            </h2>
            <p className="text-sm text-gray-800">
              Sign up today to{" "}
              <span className="text-[#00144F] font-bold">
                get 10 free downloads
              </span>
            </p>
          </div>
        </div>
        ...
        <div className="flex gap-2 md:hidden border-2 border-white p-1 rounded-lg w-full mb-4">
          <button
            ...
            className="w-full flex justify-center gap-2 items-center px-2 bg-white text-[#00144F] font-bold py-2 rounded-md text-[10px] hover:bg-gray-100 transition"
          >
        ...
        <div className="w-full sm:max-w-sm sm:px-12 hidden md:block">
          ...
          <div className="text-center">
            <img
              ...
              className="mx-auto w-32 sm:w-36 mb-6"
            />
            <h2 className="text-3xl sm:text-4xl font-semibold text-[#00144F] mb-2">
              Welcome back!
            </h2>
            <p className="text-sm text-gray-800">
              Join a Global Movement to Rebuild the Greatest Library in Human
              History
            </p>
          </div>
        </div>
        <div className="w-full max-w-md space-y-6 py-4 sm:p-6">
          {/* Form */}
          <form
            className="space-y-4 p-4 sm:p-6 rounded-lg border-2 border-white"
          ...
          >
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[#00144F] text-white gap-4 cursor-pointer py-2 rounded-md font-semibold text-sm transition hover:bg-opacity-90 flex justify-center items-center"
            ...
            <div className="flex items-center justify-center mt-2 space-x-2">
              ...
              <label
                htmlFor="terms"
                className="text-[10px] sm:text-sm text-gray-400"
              >
                By registering you agree to our{" "}
                <span className="font-semibold underline text-[#00144F]">
                  terms of use.
                </span>
              </label>
            </div>
          ...
          <p className="text-sm text-center sm:mt-2 text-[#00144F] font-semibold">
            ...
            <Link
              href="/auth/login"
              className="underline font-semibold text-[#DBB973]"
            >
              Login
            </Link>
          </p>
        ...
        <div className="mt-8 text-center text-[#00144F] space-y-4 md:hidden block">
          ...
          <p className="text-xs sm:text-sm max-w-sm mx-auto leading-relaxed">
            This library truly exceeded my expectations. It began with a free
            digital copy of <i>The Odyssey</i>, and soon I found myself
            listening to audiobook after audiobook on my daily runs. It’s
            inspiring knowing my involvement helps make these books accessible
            worldwide.
          </p>
          ...
          <div className="flex flex-row justify-center items-center gap-1">
            ...
            <h2 className="text-2xl font-bold text-[#00144F]">Trustpilot</h2>
          </div>

          {/* User Avatars */}
          <div className="flex justify-center mt-3 -space-x-2">
            {["user1.png", "user2.png", "user3.png", "user4.png"].map(
              (src, i) => (
                <img
                  key={i}
                  src={`/${src}`}
            ...
            <p className="text-xs text-[#00144F]">
              Supporting over <span className="font-semibold">3,000,000</span>{" "}
              users worldwide
            </p>
          </div>
        </div>
