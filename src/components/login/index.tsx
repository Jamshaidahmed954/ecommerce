      ...
      <div className="max-w-lg w-full py-12">
        ...
        <div className="text-center sm:px-12 mx-auto w-full sm:w-md">
          <img
            src="/Layer_1.png"
            alt="Logo"
            className="mx-auto w-36 sm:w-44 lg:48 mb-6"
          />
          <h2 className="text-3xl sm:text-4xl font-semibold text-[#EAC87E] mb-3">
            Welcome back!
          </h2>
        ...
        <div className="bg-white space-y-6 p-4 sm:p-8 rounded-xl shadow-md">
          ...
          <form className="space-y-4" onSubmit={handleEmailLogin}>
            <div>
              <label
                htmlFor="email"
                className="block text-sm font-medium text-[#00144F]"
              >
            ...
            <div className="flex items-center space-x-2">
              ...
              <label htmlFor="terms" className="text-sm text-[#00144F]">
                I agree to the{" "}
                <span className="font-semibold underline">terms & policy</span>
              </label>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full cursor-pointer bg-[#EAC87E] text-[#00144F] py-2 font-semibold rounded-md hover:bg-[#d4b466] transition flex items-center justify-center gap-2"
            >
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-4">
            ...
            >
              ...
              <span className="text-sm font-medium text-[#00144F]">
                Sign in with Google
              </span>
            </button>
            <button
          ...
          <p className="text-sm text-center text-[#00144F]">
            ...
            <a
              href="/auth/signup"
              className="font-semibold underline text-[#00144F]"
            >
              Sign up
            </a>
          </p>
